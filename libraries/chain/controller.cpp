...
#define SET_APP_HANDLER( receiver, contract, action) \
   ...
   SET_APP_HANDLER( btsio, btsio, newaccount );
   SET_APP_HANDLER( btsio, btsio, setcode );
   SET_APP_HANDLER( btsio, btsio, setabi );
   SET_APP_HANDLER( btsio, btsio, updateauth );
   SET_APP_HANDLER( btsio, btsio, deleteauth );
   SET_APP_HANDLER( btsio, btsio, linkauth );
   SET_APP_HANDLER( btsio, btsio, unlinkauth );
/*
   SET_APP_HANDLER( btsio, btsio, postrecovery );
   SET_APP_HANDLER( btsio, btsio, passrecovery );
   SET_APP_HANDLER( btsio, btsio, vetorecovery );
*/

   SET_APP_HANDLER( btsio, btsio, canceldelay );
   }
